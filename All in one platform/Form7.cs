...
namespace All_in_one_platform
{
    public partial class Form7 : Form
    {
        ...
        {
            Process.Start("https://www.snapchat.com/");
        }
        ...
        {
            Process.Start("https://www.tribegroup.co");
        }
        ...
        {
            Process.Start("https://www.mightynetworks.com");
        }
        ...
        {
            Process.Start("https://www.omegle.com");
        }

        private void button36_Click(object sender, EventArgs e)
        {
            Process.Start("https://y99.in");
        }

        private void button37_Click(object sender, EventArgs e)
        {
            Process.Start("https://tinder.com");
        }
        ...
        {
            Process.Start("https://www.jeevansathi.com");
        }

        private void button41_Click(object sender, EventArgs e)
        {
            Process.Start("https://www.bharatmatrimony.com");
        }
        ...
        {
            Process.Start("https://www.skype.com");
        }

        private void button44_Click(object sender, EventArgs e)
        {
            Process.Start("https://techcommunity.microsoft.com");
        }
